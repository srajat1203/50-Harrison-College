 ...
 */
@WebServlet("/Classroombycourse")
public class Classroombycourse extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public Classroombycourse() {
        super();
	...
	//	Hccourse course= HccourseDB.getline(courseid);
		...
		getServletContext().getRequestDispatcher("/disroombycourse.jsp").forward(request, response);
