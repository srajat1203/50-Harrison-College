...
<!-- create a new account -->
	<div class="container">
		...
		<form class="form-horizontal" role="myForm" action="SaveClassroomServlet" onsubmit="return validateForm()" method="post">
			<div class="form-group">
				<label class="control-label col-sm-5">Bldg Name :</label>
				<div class="col-sm-5">
					<input type="text" class="form-control" id="bldgname"
						name="bldgname" value="${hcclassroom.bldgname}">
						<input type="hidden" class="form-control" id="id"
						name="id" value="${hcclassroom.id}">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
					<input type="text" class="form-control" id="room"
						name="room" value="${hcclassroom.room}">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
					<input type="text" class="form-control" id="maxcap"
						name="maxcap" value="${hcclassroom.maxcap}">
				</div>
			</div>			
				...
				<div class="col-sm-offset-2 col-sm-5">
					<center>
						<button type="submit" class="btn btn-primary btn-lg btn-block"
							value="addstudent">Edit Classroom</button>
					</center>
				</div>
			</div>
		</form>
